   ...
   stages{
      ...
      stage('Deploy to GKE') {
            steps{
                ...
                step([$class: 'KubernetesEngineBuilder', projectId: env.PROJECT_ID, clusterName: env.CLUSTER_NAME, location: env.LOCATION, credentialsId: env.CREDENTIALS_ID , manifestPattern: 'deployment.yaml', verifyDeployments: true])
            }
        }
